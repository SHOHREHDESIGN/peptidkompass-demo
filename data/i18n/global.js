...
(function (i18n) {
  ...
  i18n.merge("de", {
    ...
    /* Footer */
    "global.footer.metaDemo": "© Peptide Compass · Angaben ohne Gewähr",
  ...
  i18n.merge("en", {
    ...
    "global.footer.metaDemo": "© Peptide Compass · provided without guarantee",
...
window.PK.i18n.merge("de", {
  ...
  "global.audit.partnerNote": "Affiliate-finanziert. Partner sind als Partner gekennzeichnet, der Status fließt nicht in den Score ein.",
...
window.PK.i18n.merge("en", {
  ...
  "global.audit.partnerNote": "Affiliate-funded. Partners are labelled as partners, the status does not enter the score.",
