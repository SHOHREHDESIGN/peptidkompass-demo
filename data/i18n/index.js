...
(function (i18n) {
  ...
  i18n.merge("de", {
    "page.index.title": "PeptidKompass · Peptid-Anbieter transparent vergleichen",
    "page.index.metaDescription": "Peptid-Anbieter transparent vergleichen: PeptidKompass prüft Labor, Rechtsrahmen, Lieferung, Sortiment und Preis. Demo-Projekt, keine medizinische Beratung.",
    "page.index.ogTitle": "PeptidKompass · Peptid-Anbieter transparent vergleichen",
    ...
    "page.index.heroLead": "PeptidKompass prüft Labor, Rechtsrahmen, Lieferung, Sortiment und Preis, damit du in Ruhe entscheidest.",
    ...
    "page.index.faq1Q": "Was ist PeptidKompass?",
    "page.index.faq1A": "PeptidKompass vergleicht Peptid-Anbieter nach Labor, Rechtsrahmen, Lieferung, Sortiment und Preis. Du siehst auf einen Blick, welcher Anbieter zu deinen Kriterien passt. Alle Bewertungen sind transparent nach unserer Methodik berechnet.",
    "page.index.faq2Q": "Sind das echte Anbieter?",
    "page.index.faq2A": "Nein, aktuell zeigt PeptidKompass acht fiktive Demo-Anbieter. Namen, Scores, Rabattcodes und Chargen sind Platzhalter. Echte Anbieter-Daten trägt Vic vor dem Live-Gang ein, klar als DEMO markiert bis dahin.",
    ...
    "page.index.faq4A": "Nein. Alle auf PeptidKompass genannten Substanzen sind ausschließlich für Forschungszwecke bestimmt. Es gibt keine Empfehlung zur Anwendung am Menschen und keine medizinische Beratung auf dieser Seite. Nur für Personen ab 18 Jahren."
  });

  i18n.merge("en", {
    "page.index.title": "PeptidKompass · Compare peptide vendors clearly",
    "page.index.metaDescription": "Compare peptide vendors clearly: PeptidKompass checks lab quality, legal framework, shipping, range, and price. Demo project, not medical advice.",
    "page.index.ogTitle": "PeptidKompass · Compare peptide vendors clearly",
    ...
    "page.index.heroLead": "PeptidKompass checks lab quality, legal framework, shipping, range, and price, so you can decide with confidence.",
    ...
    "page.index.faq1Q": "What is PeptidKompass?",
    "page.index.faq1A": "PeptidKompass compares peptide vendors by lab quality, legal framework, shipping, range, and price. You see at a glance which vendor matches your criteria. Every rating is calculated transparently per our methodology.",
    "page.index.faq2Q": "Are these real vendors?",
    "page.index.faq2A": "No, PeptidKompass currently shows eight fictional demo vendors. Names, scores, discount codes, and batches are placeholders. Vic will enter real vendor data before launch, clearly marked as DEMO until then.",
    ...
    "page.index.faq4A": "No. Every substance mentioned on PeptidKompass is intended for research use only. This page makes no recommendation for human use and offers no medical advice. For adults 18 and over only."
  });
