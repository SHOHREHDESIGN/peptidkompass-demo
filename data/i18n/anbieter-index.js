...
(function (i18n) {
  ...
  i18n.merge("de", {
    ...
    "page.anbieter-index.metaDescription": "24 geprüfte Peptid-Anbieter nach Labor, Rechtsrahmen, Lieferung, Sortiment und Preis pro mg vergleichen. Nach Land und Prüf-Status filtern, nach Score, Name, Preis/mg oder Versandzeit sortieren.",
    "page.anbieter-index.ogTitle": "Alle Anbieter im Überblick · Peptide Compass",
    "page.anbieter-index.ogDescription": "24 geprüfte Anbieter, ein Blick genügt.",

    "page.anbieter-index.h1": "Alle Anbieter im Überblick",
    "page.anbieter-index.lead": "24 geprüfte Anbieter, ein Blick genügt.",
  ...
  i18n.merge("en", {
    ...
    "page.anbieter-index.metaDescription": "Compare 24 vetted peptide vendors by lab quality, legal framework, shipping, range, and price per mg. Filter by country and verification status, sort by score, name, price per mg, or shipping time.",
    "page.anbieter-index.ogTitle": "All vendors overview · Peptide Compass",
    "page.anbieter-index.ogDescription": "24 vetted vendors, one clear view.",

    "page.anbieter-index.h1": "All vendors overview",
    "page.anbieter-index.lead": "24 vetted vendors, one clear view.",
