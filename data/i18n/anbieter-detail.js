...
(function (i18n) {
  ...
  "page.anbieter-detail.subheadTemplate": "{land} · Vorläufiger Dokumentationsscore {score}/100",
  "page.anbieter-detail.bannerAlt": "Wirkstoff-Visual: {name}",
  "page.anbieter-detail.scoreEyebrow": "So bewerten wir",
  "page.anbieter-detail.scoreTitle": "Vorläufiger Dokumentationsscore im Detail",
  "page.anbieter-detail.scoreLead": "Bewertet werden verfügbare Angaben. Fehlende Werte bleiben offen.",
  ...
  "page.anbieter-detail.coaHeadlineTemplate": "{n} CoAs erfasst, Datenstand {datum}",
  "page.anbieter-detail.coaHeadlinePublicExtern": "Öffentliche CoAs mit benanntem externem Labor",
  ...
  "page.anbieter-detail.coaBodyTemplate": "Externes Labor angegeben: {status}. Labor: {labor}. Keine gesonderte Echtheitsbestätigung durch uns.",
  ...
  "page.anbieter-detail.subheadTemplate": "{land} · Provisional documentation score {score}/100",
  "page.anbieter-detail.bannerAlt": "Peptide visual: {name}",
  "page.anbieter-detail.scoreEyebrow": "How we score",
  "page.anbieter-detail.scoreTitle": "Provisional documentation score breakdown",
  "page.anbieter-detail.scoreLead": "Available information is scored. Missing values remain unknown.",
  ...
  "page.anbieter-detail.coaHeadlineTemplate": "{n} CoAs recorded, data as of {datum}",
  "page.anbieter-detail.coaHeadlinePublicExtern": "Public CoAs with a named external laboratory",
  ...
  "page.anbieter-detail.coaBodyTemplate": "External laboratory stated: {status}. Laboratory: {labor}. Authenticity not separately confirmed by us.",
