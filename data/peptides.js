...
// Generiert von tools/build_peptides.py aus data/peptides_draft/*.json.
...
window.PK.peptides = [
  {
    ...
    mechanismus_en: "In preclinical models, BPC-157 has been described as involved in angiogenesis through the VEGFR2-AKT-eNOS pathway, supporting new blood vessel formation in injured tissue. Other studied mechanisms include upregulation of growth hormone receptors, modulation of inflammatory cytokines, and support of cell migration through the FAK-paxillin pathway. The exact mechanisms in humans are not yet fully established.",
    evidenz: [
      {
        art: "präklinisch",
        kurz: "Eine systematische Übersichtsarbeit von 2025 wertete Literatur aus den Jahren 1993 bis 2024 aus und schloss 35 präklinische Tierstudien zu Muskel-, Sehnen-, Band- und Knochenverletzungen ein, die überwiegend positive Heilungsergebnisse beschrieben.",
        kurz_en: "A 2025 systematic review evaluated literature from 1993 to 2024 and included 35 preclinical animal studies on muscle, tendon, ligament, and bone injuries, which mostly described positive healing outcomes.",
        quelle: "Vasireddi et al. 2025, HSS Journal, PMID 40756949"
      },
      {
        art: "klinisch",
        kurz: "Dieselbe Übersichtsarbeit identifizierte eine retrospektive klinische Fallserie, in der 7 von 12 Patienten nach intraartikulären Knie-Injektionen über mehr als sechs Monate eine Schmerzlinderung berichteten.",
        kurz_en: "The same review identified a retrospective clinical case series in which 7 of 12 patients reported pain relief lasting more than six months after intra-articular knee injections.",
        quelle: "Vasireddi et al. 2025, HSS Journal, PMID 40756949"
      },
      {
        art: "klinisch",
        kurz: "Eine retrospektive Auswertung von 16 Patienten mit Knieschmerzen beschrieb bei 14 von ihnen eine deutliche Besserung im Nachbeobachtungszeitraum von sechs bis zwölf Monaten. Eine Kontrollgruppe gab es nicht.",
        kurz_en: "A retrospective review of 16 patients with knee pain described significant improvement in 14 of them during a six-to-twelve-month follow-up period. There was no control group.",
        quelle: "Lee & Padgett 2021, Altern Ther Health Med, PMID 34324435"
      }
    ],
    sicherheit: [
      "Placebokontrollierte Humandaten zur Sicherheit fehlen bislang weitgehend, die meisten Sicherheitsaussagen stammen aus Tiermodellen.",
      ...
      "In den vorliegenden kleinen Humanstudien wurden keine schwerwiegenden Nebenwirkungen berichtet.",
    ...
    sicherheit_en: [
      "Placebo-controlled human safety data remain largely absent, most safety statements are drawn from animal models.",
      ...
      "The available small human studies reported no serious adverse events.",
    ...
    faq: [
      {
        q: "Ist BPC-157 ein zugelassenes Arzneimittel?",
        a: "Nein. BPC-157 ist weder in der EU noch in den USA als Arzneimittel zugelassen. Es wird im Handel ausschließlich als Forschungschemikalie für Laborzwecke angeboten, nicht für die Anwendung am Menschen.",
        q_en: "Is BPC-157 an approved medication?",
        a_en: "No. BPC-157 is not approved as a medication in the EU or the United States. It is sold commercially only as a research chemical for laboratory use, not for human use."
      },
      {
        q: "Woher stammt die Sequenz von BPC-157?",
        a: "Sie ist von einem Schutzprotein abgeleitet, das im menschlichen Magensaft vorkommt. Daraus leitet sich auch der Name Body Protection Compound ab.",
        q_en: "Where does the BPC-157 sequence come from?",
        a_en: "It is derived from a protective protein found in human gastric juice, which is also the origin of the name Body Protection Compound."
      },
      {
        q: "Gibt es Humanstudien zu BPC-157?",
        a: "Es gibt einige kleine, methodisch schwache Studien und Fallserien, aber keine großen, placebokontrollierten Studien. Der Großteil der Evidenz stammt aus Tiermodellen.",
        q_en: "Are there human studies on BPC-157?",
        a_en: "There are a few small studies and case series with methodological limitations, but no large, placebo-controlled trials. Most of the evidence comes from animal models."
      }
    ],
    seo: {
      title: "BPC-157: Wirkstoff-Profil & Studienlage",
      title_en: "BPC-157: Research Profile & Evidence",
  ...
  },
  {
    ...
    kategorie: "Regeneration",
    studienlage: "präklinisch",
    kurz: "Ein synthetisches Fragment des körpereigenen Proteins Thymosin Beta-4, in der präklinischen Forschung zu Zellmigration und Geweberegeneration untersucht.",
    kurz_en: "A synthetic fragment of the body's own protein thymosin beta-4, studied in preclinical research on cell migration and tissue regeneration.",
    beschreibung: "TB-500 ist die synthetisch hergestellte, sieben Aminosäuren umfassende Kernsequenz des körpereigenen Proteins Thymosin Beta-4. Die meisten verfügbaren Wirkdaten, einschließlich der klinischen Studien, beziehen sich auf das vollständige Thymosin Beta-4 mit 43 Aminosäuren, nicht auf das isolierte Fragment TB-500 selbst. Untersucht werden unter anderem Zellmigration, Angiogenese und eine mögliche Rolle bei der Aktivierung von Haarfollikeln.",
    beschreibung_en: "TB-500 is the synthetically produced, seven-amino-acid core sequence of the body's own protein thymosin beta-4. Most available data, including clinical studies, relate to the full 43-amino-acid thymosin beta-4, not to the isolated TB-500 fragment itself. Areas of study include cell migration, angiogenesis, and a possible role in hair follicle activation.",
    mechanismus: "Die untersuchte Kernsequenz bindet an G-Actin, einen Baustein des Zytoskeletts, und beeinflusst darüber die Beweglichkeit von Zellen im Gewebe. Am vollständigen Thymosin Beta-4 wurde zudem eine Beteiligung an der Angiogenese über eine erhöhte VEGF-Expression sowie eine entzündungsregulierende Wirkung über den NF-κB-Signalweg beschrieben. Ob sich diese Mechanismen vollständig auf das isolierte Fragment TB-500 übertragen lassen, ist wissenschaftlich nicht abschließend geklärt.",
    mechanismus_en: "The studied core sequence binds G-actin, a building block of the cytoskeleton, thereby influencing cell movement within tissue. In the full thymosin beta-4 protein, involvement in angiogenesis through increased VEGF expression and an inflammation-regulating effect through the NF-κB pathway have also been described. Whether these mechanisms fully transfer to the isolated TB-500 fragment is not scientifically settled.",
    evidenz: [
      {
        art: "präklinisch",
        kurz: "Eine Studie an Ratten und Mäusen beschrieb, dass die aktive Sequenz von Thymosin Beta-4, die auch TB-500 bildet, die Migration von Stammzellen im Haarfollikel beeinflusst.",
        kurz_en: "A study in rats and mice described that the active sequence of thymosin beta-4, which also forms TB-500, influenced stem cell migration within the hair follicle.",
        quelle: "Philp et al. 2004, FASEB Journal, PMID 14657002"
      },
      {
        art: "klinisch",
        kurz: "Eine randomisierte, placebokontrollierte klinische Studie an Patienten mit schwerem trockenem Auge untersuchte eine Augentropfen-Formulierung mit dem vollständigen Thymosin Beta-4 und beschrieb eine Besserung von Anzeichen und Symptomen gegenüber Placebo. Die Studie betraf das vollständige Protein, nicht das TB-500-Fragment selbst.",
        kurz_en: "A randomized, placebo-controlled clinical trial in patients with severe dry eye tested an eye-drop formulation of the full thymosin beta-4 protein and described improved signs and symptoms compared with placebo. The trial involved the full protein, not the TB-500 fragment itself.",
        quelle: "Sosne et al. 2015, Cornea, PMID 25826322"
      }
    ],
    sicherheit: [
      "Für TB-500 als isoliertes Fragment liegen keine eigenständigen kontrollierten Humanstudien zur Sicherheit vor.",
      "Am vollständigen Thymosin Beta-4 wurden in klinischen Studien überwiegend milde und vorübergehende Nebenwirkungen beschrieben.",
      "Auf mechanistischer Ebene wird eine theoretische Verbindung zwischen angiogenesefördernden Effekten und bestehendem Tumorwachstum diskutiert, ein ursächlicher Zusammenhang ist nicht belegt.",
      "Thymosin Beta-4 und verwandte Fragmente stehen auf der Verbotsliste der Welt-Anti-Doping-Agentur."
    ],
    sicherheit_en: [
      "For TB-500 as an isolated fragment, no independent controlled human safety studies are available.",
      "For the full thymosin beta-4 protein, clinical studies have described mostly mild and transient side effects.",
      "On a mechanistic level, a theoretical link between angiogenesis-promoting effects and existing tumor growth is discussed, a causal connection has not been established.",
    ...
    faq: [
      {
        q: "Ist TB-500 dasselbe wie Thymosin Beta-4?",
        a: "Nein. TB-500 ist ein synthetisches Fragment aus sieben Aminosäuren der insgesamt 43 Aminosäuren langen Sequenz von Thymosin Beta-4. Die meisten klinischen Daten beziehen sich auf das vollständige Protein, nicht auf das Fragment.",
        q_en: "Is TB-500 the same as thymosin beta-4?",
        a_en: "No. TB-500 is a synthetic seven-amino-acid fragment of the full 43-amino-acid thymosin beta-4 sequence. Most clinical data relate to the full protein, not the fragment."
      },
      {
        q: "Gibt es klinische Studien zu TB-500 selbst?",
        a: "Eigenständige kontrollierte Humanstudien zum isolierten TB-500-Fragment liegen nicht vor. Verfügbare klinische Daten stammen vom vollständigen Thymosin Beta-4.",
        q_en: "Are there clinical studies on TB-500 itself?",
        a_en: "No independent controlled human studies on the isolated TB-500 fragment are available. Available clinical data come from the full thymosin beta-4 protein."
      },
      {
        q: "Ist TB-500 dopingrelevant?",
        a: "Thymosin Beta-4 und verwandte Fragmente stehen auf der Verbotsliste der Welt-Anti-Doping-Agentur.",
        q_en: "Is TB-500 relevant to anti-doping rules?",
        a_en: "Thymosin beta-4 and related fragments are on the World Anti-Doping Agency prohibited list."
      }
    ],
    seo: {
      title: "TB-500: Wirkstoff-Profil & Studienlage",
      title_en: "TB-500: Research Profile & Evidence",
  ...
  },
  {
    ...
    kategorie: "Stoffwechsel",
    studienlage: "frühe klinische Studien",
    kurz: "Mitochondrial kodiertes Peptid, das als Bewegungsmimetikum in der Stoffwechselforschung untersucht wird.",
    kurz_en: "A mitochondrially encoded peptide studied as an exercise mimetic in metabolic research.",
    beschreibung: "MOTS-c ist ein aus 16 Aminosäuren bestehendes Peptid, das nicht im Zellkern, sondern direkt im Erbgut der Mitochondrien kodiert ist. Es wurde 2015 entdeckt und wird als körpereigenes Signalmolekül untersucht, das bei körperlicher Belastung vermehrt ausgeschüttet wird. Die Forschung konzentriert sich auf mögliche Effekte auf Insulinsensitivität, Fettstoffwechsel und Zellalterung.",
    beschreibung_en: "MOTS-c is a 16-amino-acid peptide encoded directly in mitochondrial DNA rather than in the cell nucleus. It was discovered in 2015 and is studied as an endogenous signaling molecule that is released in greater amounts during physical exertion. Research focuses on possible effects on insulin sensitivity, fat metabolism, and cellular aging.",
    mechanismus: "MOTS-c hemmt den Folatzyklus in der Zelle, wodurch sich der Botenstoff AICAR anreichert und den zentralen Energiesensor AMPK aktiviert. Über diesen Signalweg werden unter anderem die Aufnahme von Glukose in die Muskelzelle und die Fettsäureoxidation angeregt. Unter metabolischem Stress wandert MOTS-c zusätzlich in den Zellkern und beeinflusst dort die Ablesung von Genen, die an der Stressanpassung beteiligt sind.",
    mechanismus_en: "MOTS-c inhibits the cell's folate cycle, causing the messenger molecule AICAR to accumulate and activate the central energy sensor AMPK. This pathway stimulates, among other things, glucose uptake into muscle cells and fatty acid oxidation. Under metabolic stress, MOTS-c also moves into the cell nucleus, where it influences the expression of genes involved in stress adaptation.",
    evidenz: [
      {
        art: "präklinisch",
        kurz: "In der Erstbeschreibung verhinderte MOTS-c bei Mäusen unter fettreicher Diät über mehrere Wochen die Entstehung von Insulinresistenz und stellte bei alten Mäusen die Insulinsensitivität junger Tiere wieder her.",
        kurz_en: "In the original description, MOTS-c prevented the development of insulin resistance in mice on a high-fat diet over several weeks and restored the insulin sensitivity of young animals in old mice.",
        quelle: "Lee et al. 2015, Cell Metabolism 21(3):443-454"
      },
      {
        art: "präklinisch",
        kurz: "Bei älteren Mäusen verlängerte eine über mehrere Wochen wiederholt verabreichte Gabe von MOTS-c die mittlere Lebensspanne um 5 bis 7 Prozent und verbesserte Ausdauer, Griffkraft und Gleichgewicht gegenüber Placebo.",
        kurz_en: "In older mice, repeated administration of MOTS-c over several weeks extended median lifespan by 5 to 7 percent and improved endurance, grip strength, and balance compared with placebo.",
        quelle: "Reynolds et al. 2021, Nature Communications, DOI 10.1038/s41467-020-20790-0"
      },
      {
        art: "klinisch",
        kurz: "In einer Beobachtungsstudie an 20 körperlich aktiven Erwachsenen korrelierte der Serumspiegel von MOTS-c positiv mit Sprungkraft, Maximalkraft und Muskelmasse der Beine, jedoch nicht mit der maximalen Sauerstoffaufnahme.",
        kurz_en: "In an observational study of 20 physically active adults, serum MOTS-c levels correlated positively with jump power, maximal strength, and leg muscle mass, but not with maximal oxygen uptake.",
        quelle: "Domin et al. 2023, International Journal of Molecular Sciences"
      }
    ],
    sicherheit: [
      "In publizierten Tierstudien über bis zu sechs Monate wurden keine relevanten Nebenwirkungen berichtet.",
      "Am häufigsten berichtet werden lokale Reaktionen an der Injektionsstelle wie Brennen und Rötung.",
      "MOTS-c hemmt den Folatzyklus, ein möglicher Folatmangel bei längerer Anwendung ist bislang nur theoretisch beschrieben.",
      "Kontrollierte Interventionsstudien am Menschen zu Wirkung und Sicherheit liegen bislang nicht vor."
    ],
    sicherheit_en: [
      "Published animal studies of up to six months reported no relevant side effects.",
      "The most commonly reported effect is a local injection-site reaction such as burning and redness.",
      "MOTS-c inhibits the folate cycle; a possible folate deficiency with longer use has so far only been described theoretically.",
    ...
    faq: [
      {
        q: "Was macht MOTS-c anders als andere Peptide",
        a: "MOTS-c ist nicht im Zellkern, sondern direkt im Erbgut der Mitochondrien kodiert. Es wirkt über den zellulären Energiesensor AMPK und wird deshalb als Bewegungsmimetikum eingeordnet.",
        q_en: "What makes MOTS-c different from other peptides",
        a_en: "MOTS-c is encoded directly in mitochondrial DNA rather than in the cell nucleus. It acts through the cellular energy sensor AMPK and is therefore classified as an exercise mimetic."
      },
      {
        q: "Ist MOTS-c als Arzneimittel zugelassen",
        a: "Nein. MOTS-c ist weder in der EU noch in den USA als Arzneimittel oder Lebensmittel zugelassen und wird ausschließlich als Forschungschemikalie gehandelt.",
        q_en: "Is MOTS-c an approved medication",
        a_en: "No. MOTS-c is not approved as a medication or food product in either the EU or the US and is sold exclusively as a research chemical."
      },
      {
        q: "Wie belastbar sind die Daten zu MOTS-c beim Menschen",
        a: "Bislang begrenzt. Es liegen vor allem präklinische Tierstudien sowie eine Beobachtungsstudie zur Korrelation mit Muskelkraft beim Menschen vor, kontrollierte Interventionsstudien am Menschen fehlen bisher.",
        q_en: "How robust is the human data on MOTS-c",
        a_en: "Limited so far. Evidence mainly consists of preclinical animal studies and one human observational study on correlation with muscle strength; controlled human intervention trials are still lacking."
      }
    ],
    seo: {
      title: "MOTS-c im Forschungsüberblick",
      title_en: "MOTS-c Research Overview",
  ...
  },
  {
    ...
    kategorie: "Stoffwechsel",
    studienlage: "klinisch untersucht",
    kurz: "Peptid, das gleichzeitig an GLP-1-, GIP- und Glucagon-Rezeptoren wirkt und sich in fortgeschrittener klinischer Prüfung zur Stoffwechselregulation befindet.",
    kurz_en: "A peptide that acts on GLP-1, GIP, and glucagon receptors simultaneously, currently in advanced clinical trials related to metabolic regulation.",
    beschreibung: "Retatrutid ist ein sogenannter Triple-Agonist, der an drei Stoffwechsel-Rezeptoren gleichzeitig ansetzt: GLP-1, GIP und Glucagon. Es befindet sich in Phase-3-Studien und ist bisher in keinem Land als Arzneimittel zugelassen.",
    beschreibung_en: "Retatrutide is a so-called triple agonist that acts on three metabolic receptors simultaneously: GLP-1, GIP, and glucagon. It is currently in phase 3 trials and is not approved as a medication in any country to date.",
    mechanismus: "Über den GLP-1-Rezeptor wird eine Sättigungsregulation sowie eine verlangsamte Magenentleerung beschrieben. Der GIP-Rezeptor wird mit einer verstärkten Insulinsekretion und einer möglichen Pufferung gastrointestinaler Effekte in Verbindung gebracht. Die zusätzliche Wirkung am Glucagon-Rezeptor wird mit einem erhöhten Energieverbrauch über die Leber sowie der Aktivierung von braunem Fettgewebe assoziiert.",
    mechanismus_en: "Through the GLP-1 receptor, effects on satiety regulation and slowed gastric emptying have been described. The GIP receptor has been linked to enhanced insulin secretion and a possible buffering of gastrointestinal effects. The additional action at the glucagon receptor has been associated with increased hepatic energy expenditure and activation of brown adipose tissue.",
    evidenz: [
      {
        art: "klinisch",
        kurz: "In einer randomisierten Phase-2-Studie an Erwachsenen mit Adipositas zeigte sich nach 48 Wochen unter Retatrutid ein deutlich höherer Anteil an Teilnehmenden mit relevantem Körpergewichtsverlust als unter Placebo.",
        kurz_en: "In a randomized phase 2 trial in adults with obesity, a markedly higher proportion of participants on retatrutide achieved relevant body weight loss after 48 weeks compared to placebo.",
        quelle: "Jastreboff AM et al. 2023, New England Journal of Medicine 389:514-526, PMID 37366315"
      },
      {
        art: "klinisch",
        kurz: "In einer Teilstudie mit Teilnehmenden mit begleitender Fettlebererkrankung wurde nach 24 Wochen eine mit der Wirkstoffmenge zunehmende, im MRT gemessene Reduktion des Leberfettanteils beobachtet.",
        kurz_en: "In a substudy with participants with concurrent fatty liver disease, an MRI-measured reduction in liver fat content that increased with the administered amount was observed after 24 weeks.",
        quelle: "Sanyal AJ et al. 2024, Nature Medicine"
      },
      {
        art: "klinisch",
        kurz: "In einer Phase-2-Studie an Personen mit Typ-2-Diabetes senkte Retatrutid den HbA1c-Wert stärker als die aktive Vergleichssubstanz Dulaglutid, bei gleichzeitig größerem Körpergewichtsverlust.",
        kurz_en: "In a phase 2 trial in people with type 2 diabetes, retatrutide lowered HbA1c more than the active comparator dulaglutide, alongside greater body weight loss.",
        quelle: "Rosenstock J et al. 2023, The Lancet 402:529-544, PMID 37385280"
      }
    ],
    sicherheit: [
      "Die häufigsten in Studien berichteten Effekte sind gastrointestinal, unter anderem Übelkeit und Durchfall, und nehmen über den Studienverlauf ab.",
      "Bei höherer Wirkstoffmenge wurde in Studien eine erhöhte Abbruchrate gegenüber Placebo beobachtet.",
      "In einer Phase-3-Studie wurde bei einem Teil der Teilnehmenden in der höheren Wirkstoffgruppe eine Dysästhesie (Kribbeln oder Taubheitsgefühl an Extremitäten) berichtet, meist rückläufig im Studienverlauf.",
      "Da Retatrutid nirgends als Arzneimittel zugelassen ist, liegen keine offiziellen Fachinformationen zur Langzeitsicherheit vor."
    ],
    sicherheit_en: [
      "The most commonly reported effects in trials are gastrointestinal, including nausea and diarrhea, and decrease over the course of the studies.",
      "At the higher amount, trials observed a higher discontinuation rate compared to placebo.",
      "In a phase 3 trial, some participants in the higher-amount group reported dysesthesia (tingling or numbness in the extremities), mostly resolving over the course of the study.",
    ...
    faq: [
      {
        q: "Ist Retatrutid bereits als Medikament erhältlich?",
        a: "Nein. Retatrutid befindet sich in Phase-3-Studien, eine Zulassung wird laut Herstellerangaben frühestens 2027 erwartet. Aktuell ist es kein zugelassenes Arzneimittel.",
        q_en: "Is retatrutide already available as a medication?",
        a_en: "No. Retatrutide is currently in phase 3 trials, with approval expected at the earliest in 2027 according to the manufacturer. It is currently not an approved medication."
      },
      {
        q: "Was unterscheidet Retatrutid von Semaglutid?",
        a: "Semaglutid wirkt nur am GLP-1-Rezeptor, Retatrutid zusätzlich an GIP- und Glucagon-Rezeptoren. In klinischen Studien zeigte sich dadurch ein größerer Effekt auf Körpergewicht und Leberfett.",
        q_en: "What sets retatrutide apart from semaglutide?",
        a_en: "Semaglutide acts only on the GLP-1 receptor, while retatrutide additionally acts on the GIP and glucagon receptors. Clinical trials showed a larger effect on body weight and liver fat as a result."
      },
      {
        q: "Woher stammt Retatrutid?",
        a: "Retatrutid wurde vom Pharmaunternehmen Eli Lilly entwickelt und wird in mehreren Phase-3-Studien unter dem Programmnamen TRIUMPH untersucht.",
        q_en: "Where does retatrutide come from?",
        a_en: "Retatrutide was developed by the pharmaceutical company Eli Lilly and is being studied in several phase 3 trials under the TRIUMPH program name."
      }
    ],
    seo: {
      title: "Retatrutid: Triple-Agonist in Phase-3-Studien",
      title_en: "Retatrutide: Triple Agonist in Phase 3 Trials",
  ...
  },
  {
    ...
    kurz: "GLP-1-Rezeptor-Agonist, als zugelassenes Arzneimittel bekannt und hier als Forschungssubstanz zur Stoffwechselregulation gelistet.",
    kurz_en: "A GLP-1 receptor agonist, known as an approved medication and listed here as a research substance for metabolic regulation.",
    beschreibung: "Semaglutid ist ein GLP-1-Rezeptor-Agonist und als Arzneimittel unter mehreren Handelsnamen zugelassen. Es ist Gegenstand umfangreicher klinischer Forschung zur Stoffwechsel- und Sättigungsregulation. Die hier gelisteten Forschungschargen sind nicht mit zugelassenen Arzneimitteln gleichzusetzen und ausschließlich für Laborzwecke bestimmt.",
    beschreibung_en: "Semaglutide is a GLP-1 receptor agonist approved as a medication under several brand names. It is the subject of extensive clinical research on metabolic and satiety regulation. The research batches listed here are not equivalent to approved medications and are intended for laboratory use only.",
    mechanismus: "Semaglutid aktiviert den GLP-1-Rezeptor und beeinflusst darüber die Hungerregulation im Hypothalamus, verlangsamt die Magenentleerung und stimuliert glukoseabhängig die Insulinausschüttung. Die glukoseabhängige Wirkung wird als Grund für das im Vergleich zu Insulin geringere Unterzuckerungsrisiko beschrieben.",
    mechanismus_en: "Semaglutide activates the GLP-1 receptor, which influences hunger regulation in the hypothalamus, slows gastric emptying, and stimulates insulin release in a glucose-dependent manner. This glucose-dependent action is described as the reason for its lower hypoglycemia risk compared to insulin.",
    evidenz: [
      {
        art: "klinisch",
        kurz: "In einer randomisierten Studie an 1.961 Erwachsenen mit Übergewicht oder Adipositas führte wöchentliches Semaglutid über 68 Wochen zu einem mittleren Körpergewichtsverlust von 14,9 Prozent gegenüber 2,4 Prozent unter Placebo.",
        kurz_en: "In a randomized trial with 1,961 adults with overweight or obesity, weekly semaglutide over 68 weeks led to a mean body weight loss of 14.9 percent versus 2.4 percent under placebo.",
        quelle: "Wilding JPH et al. 2021, New England Journal of Medicine, PMID 33567185"
      },
      {
        art: "klinisch",
        kurz: "In einer kardiovaskulären Endpunktstudie an 3.297 Personen mit Typ-2-Diabetes und erhöhtem kardiovaskulärem Risiko wurde unter Semaglutid eine um 26 Prozent geringere Rate schwerer kardiovaskulärer Ereignisse gegenüber Placebo beobachtet.",
        kurz_en: "In a cardiovascular outcomes trial with 3,297 people with type 2 diabetes and elevated cardiovascular risk, semaglutide was associated with a 26 percent lower rate of major cardiovascular events compared to placebo.",
        quelle: "Marso SP et al. 2016, New England Journal of Medicine 375:1834-1844, PMID 27633186"
      }
    ],
    sicherheit: [
      "Häufig berichtete Effekte sind gastrointestinal, insbesondere Übelkeit, Durchfall und Erbrechen, meist vorübergehend im Verlauf der Anwendung.",
      "In seltenen Fällen wurde in der Fachliteratur ein möglicher Zusammenhang mit einer nicht-arteriitischen anterioren ischämischen Optikusneuropathie diskutiert.",
      "Laut Fachinformation ist die Anwendung bei persönlicher oder familiärer Vorgeschichte von medullärem Schilddrüsenkarzinom kontraindiziert."
    ],
    sicherheit_en: [
      "Commonly reported effects are gastrointestinal, particularly nausea, diarrhea, and vomiting, mostly transient over the course of use.",
      "Rare cases discussed in the literature include a possible link to non-arteritic anterior ischemic optic neuropathy.",
    ...
    faq: [
      {
        q: "Ist Semaglutid ein zugelassenes Medikament?",
        a: "Ja, Semaglutid ist unter den Namen Ozempic, Wegovy und Rybelsus als verschreibungspflichtiges Arzneimittel zugelassen. Die hier beschriebene Substanz ist eine reine Forschungscharge, kein Fertigarzneimittel.",
        q_en: "Is semaglutide an approved medication?",
        a_en: "Yes, semaglutide is approved as a prescription medication under the names Ozempic, Wegovy, and Rybelsus. The substance described here is a research batch only, not a finished pharmaceutical product."
      },
      {
        q: "Worin unterscheidet sich Semaglutid von Retatrutid?",
        a: "Semaglutid wirkt allein am GLP-1-Rezeptor, Retatrutid zusätzlich an GIP- und Glucagon-Rezeptoren. Retatrutid befindet sich zudem noch in Phase-3-Studien, Semaglutid ist bereits zugelassen.",
        q_en: "How does semaglutide differ from retatrutide?",
        a_en: "Semaglutide acts only on the GLP-1 receptor, while retatrutide additionally acts on the GIP and glucagon receptors. Retatrutide is also still in phase 3 trials, while semaglutide is already approved."
      },
      {
        q: "Wofür wird Semaglutid als Arzneimittel eingesetzt?",
        a: "Als zugelassenes Arzneimittel wird Semaglutid bei Typ-2-Diabetes und zur Gewichtsregulation verschrieben. Diese Seite beschreibt die Substanz ausschließlich als Forschungschemikalie für Laborzwecke.",
        q_en: "What is semaglutide used for as a medication?",
        a_en: "As an approved medication, semaglutide is prescribed for type 2 diabetes and weight management. This page describes the substance exclusively as a research chemical for laboratory purposes."
      }
    ],
    seo: {
      title: "Semaglutid: GLP-1-Wirkstoff im Forschungskontext",
      title_en: "Semaglutide: GLP-1 Compound in a Research Context",
  ...
  },
  {
    ...
    studienlage: "frühe klinische Studien",
    kurz: "Synthetisches Analogon des Growth-Hormone-Releasing-Hormons, in zwei Varianten mit unterschiedlicher Wirkdauer erforscht.",
    kurz_en: "A synthetic analog of growth hormone-releasing hormone, studied in two variants with different durations of action.",
    beschreibung: "CJC-1295 ist ein stabilisiertes Analogon des körpereigenen GHRH und wird im Kontext der Wachstumshormon-Achse untersucht. Es existiert in zwei Varianten: ohne DAC (Drug Affinity Complex) mit kurzer Wirkdauer und mit DAC, das über eine Bindung an Serum-Albumin eine deutlich verlängerte Wirkdauer erreicht. Die vorliegenden Humandaten stammen überwiegend aus früher klinischer Forschung an gesunden Erwachsenen.",
    beschreibung_en: "CJC-1295 is a stabilized analog of the body's own GHRH, studied in the context of the growth hormone axis. It exists in two variants: without DAC (Drug Affinity Complex), which has a short duration of action, and with DAC, which achieves a substantially extended duration through binding to serum albumin. Available human data come mainly from early clinical research in healthy adults.",
    mechanismus: "CJC-1295 bindet an den GHRH-Rezeptor der somatotropen Zellen in der Hypophyse und löst darüber die körpereigene, pulsatile Ausschüttung von Wachstumshormon aus. Ohne DAC wird das Molekül innerhalb von Minuten abgebaut, was einen kurzen, ausgeprägten Hormonpuls erzeugt. Mit DAC bindet ein chemischer Anker kovalent an Albumin im Blut, wodurch die Wirkdauer auf mehrere Tage verlängert wird, während die pulsatile Freisetzung laut Studien erhalten bleibt.",
    mechanismus_en: "CJC-1295 binds to the GHRH receptor on somatotroph cells in the pituitary gland, triggering the body's own pulsatile release of growth hormone. Without DAC, the molecule is broken down within minutes, producing a short, pronounced hormone pulse. With DAC, a chemical anchor binds covalently to albumin in the blood, extending the duration of action to several days, while studies indicate the pulsatile release pattern is preserved.",
    evidenz: [
      {
        art: "klinisch",
        kurz: "Zwei randomisierte, placebokontrollierte Studien mit stufenweise ansteigender Wirkstoffmenge an gesunden Erwachsenen: eine einzelne Injektion von CJC-1295 mit DAC erhöhte den Wachstumshormonspiegel über mehrere Tage und den IGF-1-Spiegel für 9 bis 11 Tage.",
        kurz_en: "Two randomized, placebo-controlled trials in healthy adults with step-wise increasing amounts: a single injection of CJC-1295 with DAC raised growth hormone levels for several days and IGF-1 levels for 9 to 11 days.",
        quelle: "Teichman et al. 2006, Journal of Clinical Endocrinology & Metabolism, PMID 16352683"
      },
      {
        art: "klinisch",
        kurz: "Eine Folgeuntersuchung an denselben Probanden zeigte, dass die pulsatile Ausschüttung von Wachstumshormon auch unter der verlängerten Stimulation durch CJC-1295 mit DAC erhalten blieb.",
        kurz_en: "A follow-up analysis of the same subjects found that pulsatile growth hormone release was preserved even under the extended stimulation from CJC-1295 with DAC.",
        quelle: "Ionescu & Frohman 2006, Journal of Clinical Endocrinology & Metabolism, PMID 17018654"
      }
    ],
    sicherheit: [
      "In den vorliegenden Studien traten überwiegend milde, lokale Reaktionen an der Injektionsstelle auf.",
      "Eine Phase-2-Studie zu CJC-1295 mit DAC bei einer anderen Erkrankung wurde nach einem Todesfall vorsorglich eingestellt, ein ursächlicher Zusammenhang mit dem Peptid wurde nicht festgestellt.",
      "Langfristige Auswirkungen eines dauerhaft erhöhten IGF-1-Spiegels beim Menschen sind wissenschaftlich nicht abschließend geklärt.",
      "Humanklinische Langzeitdaten zur Sicherheit liegen bislang nicht vor."
    ],
    sicherheit_en: [
      "In the available studies, mostly mild, local reactions at the injection site were reported.",
      "A phase 2 trial of CJC-1295 with DAC for an unrelated condition was discontinued as a precaution after a participant died; a causal link to the peptide was not established.",
      "The long-term effects of a persistently elevated IGF-1 level in humans are not fully understood.",
    ...
    faq: [
      {
        q: "Was unterscheidet CJC-1295 mit und ohne DAC",
        a: "Ohne DAC wird das Peptid innerhalb von Minuten abgebaut und erzeugt einen kurzen, ausgeprägten Hormonpuls. Mit DAC bindet ein chemischer Anker an Albumin im Blut, wodurch die Wirkdauer auf mehrere Tage verlängert wird, während die pulsatile Freisetzung laut Studien erhalten bleibt.",
        q_en: "What is the difference between CJC-1295 with and without DAC",
        a_en: "Without DAC, the peptide is broken down within minutes, producing a short, pronounced hormone pulse. With DAC, a chemical anchor binds to albumin in the blood, extending the duration to several days, while studies indicate the pulsatile release pattern is preserved."
      },
      {
        q: "Ist CJC-1295 als Arzneimittel zugelassen",
        a: "Nein. CJC-1295 ist weder in der EU noch in den USA als Arzneimittel zugelassen und wird ausschließlich als Forschungschemikalie für Laborzwecke gehandelt.",
        q_en: "Is CJC-1295 an approved medication",
        a_en: "No. CJC-1295 is not approved as a medication in the EU or the US and is sold exclusively as a research chemical for laboratory use."
      },
      {
        q: "Wofür wird CJC-1295 in der Forschung untersucht",
        a: "CJC-1295 wird im Zusammenhang mit der Wachstumshormon-Achse untersucht, insbesondere im Hinblick auf die körpereigene Ausschüttung von Wachstumshormon und die daraus folgende IGF-1-Bildung in der Leber.",
        q_en: "What is CJC-1295 studied for in research",
        a_en: "CJC-1295 is studied in the context of the growth hormone axis, particularly regarding the body's own release of growth hormone and the resulting IGF-1 production in the liver."
      }
    ],
    seo: {
      title: "CJC-1295 im Forschungsüberblick",
      title_en: "CJC-1295 Research Overview",
  ...
  },
  {
    ...
    kategorie: "Wachstumshormon-Achse",
    studienlage: "frühe klinische Studien",
    kurz: "Selektives Pentapeptid aus der Klasse der Growth-Hormone-Releasing-Peptide, in früher klinischer Forschung untersucht.",
    kurz_en: "A selective pentapeptide from the growth hormone-releasing peptide class, studied in early clinical research.",
    beschreibung: "Ipamorelin ist ein aus fünf Aminosäuren bestehendes synthetisches Peptid, das den körpereigenen Botenstoff Ghrelin nachahmt. Es wurde 1998 als erster selektiver Vertreter seiner Wirkstoffklasse beschrieben und in klinischen Studien unter anderem bei Patienten nach Bauchoperationen untersucht. Für Wachstumshormon-bezogene Anwendungen liegen bislang keine kontrollierten Studien an gesunden Erwachsenen vor.",
    beschreibung_en: "Ipamorelin is a synthetic peptide made up of five amino acids that mimics the body's own messenger ghrelin. It was first described in 1998 as the first selective member of its drug class and has been studied in clinical trials including in patients recovering from abdominal surgery. For growth hormone-related applications, no controlled studies in healthy adults are available to date.",
    mechanismus: "Ipamorelin bindet selektiv an den Ghrelin-Rezeptor (GHS-R1A) im Hypothalamus und in der Hypophyse und lockert dadurch die hemmende Wirkung von Somatostatin. Das führt zur pulsatilen Ausschüttung von körpereigenem Wachstumshormon aus der Hypophyse. Im Unterschied zu älteren Peptiden derselben Klasse zeigte Ipamorelin in Studien keine relevante Erhöhung von ACTH, Cortisol oder Prolaktin.",
    mechanismus_en: "Ipamorelin selectively binds to the ghrelin receptor (GHS-R1A) in the hypothalamus and pituitary gland, loosening the inhibitory effect of somatostatin. This leads to pulsatile release of the body's own growth hormone from the pituitary gland. Unlike older peptides in the same class, studies found no relevant increase in ACTH, cortisol, or prolactin with ipamorelin.",
    evidenz: [
      {
        art: "präklinisch",
        kurz: "Die Erstbeschreibung im Schweinemodell zeigte, dass Ipamorelin Wachstumshormon freisetzt, ohne ACTH, Cortisol, Prolaktin, FSH oder LH relevant zu beeinflussen, anders als ältere Peptide derselben Klasse.",
        kurz_en: "The original description in a pig model showed that ipamorelin releases growth hormone without a relevant effect on ACTH, cortisol, prolactin, FSH, or LH, unlike older peptides in the same class.",
        quelle: "Raun et al. 1998, European Journal of Endocrinology, PMID 9849822"
      },
      {
        art: "präklinisch",
        kurz: "In einem Rattenmodell für postoperative Darmlähmung beschleunigte Ipamorelin die Wiederaufnahme der Darmbewegung nach einer Operation.",
        kurz_en: "In a rat model of postoperative bowel paralysis, ipamorelin accelerated the return of bowel movement after surgery.",
        quelle: "Venkova et al. 2009, Journal of Pharmacology and Experimental Therapeutics, PMID 19289567"
      },
      {
        art: "klinisch",
        kurz: "In einer randomisierten, placebokontrollierten Phase-2-Studie an 117 Patienten nach Darmoperationen unterschied sich die Zeit bis zur ersten vertragenen Mahlzeit zwischen Ipamorelin- und Placebogruppe statistisch nicht.",
        kurz_en: "In a randomized, placebo-controlled phase 2 trial in 117 patients after bowel surgery, the time to the first tolerated meal did not differ statistically between the ipamorelin and placebo groups.",
        quelle: "International Journal of Colorectal Disease 2014, DOI 10.1007/s00384-014-2030-8"
      }
    ],
    sicherheit: [
      "In der bislang größten kontrollierten Studie waren die berichteten unerwünschten Ereignisse in der Ipamorelin- und der Placebogruppe ähnlich häufig.",
      "Die klinische Entwicklung von Ipamorelin wurde von der FDA 2023 eingestellt, nachdem in der Studienpopulation zwei Todesfälle aufgetreten waren, ein ursächlicher Zusammenhang mit dem Peptid gilt als wissenschaftlich umstritten.",
      "Langzeitdaten zur Sicherheit bei gesunden Erwachsenen liegen nicht vor.",
      "Wechselwirkungen mit anderen Hormonachsen sind nicht abschließend untersucht."
    ],
    sicherheit_en: [
      "In the largest controlled trial to date, reported adverse events were similarly frequent in the ipamorelin and placebo groups.",
      "The FDA halted ipamorelin's clinical development in 2023 after two deaths occurred in the study population; a causal link to the peptide is considered scientifically disputed.",
    ...
    faq: [
      {
        q: "Erhöht Ipamorelin Cortisol wie ältere Peptide derselben Klasse",
        a: "In den vorliegenden Studien zeigte Ipamorelin im Gegensatz zu älteren Peptiden wie GHRP-6 oder GHRP-2 keine relevante Erhöhung von ACTH oder Cortisol. Das gilt als sein wissenschaftlich am besten belegtes Unterscheidungsmerkmal.",
        q_en: "Does ipamorelin raise cortisol like older peptides in the same class",
        a_en: "In the available studies, unlike older peptides such as GHRP-6 or GHRP-2, ipamorelin showed no relevant increase in ACTH or cortisol. This is considered its best scientifically documented distinguishing feature."
      },
      {
        q: "Ist Ipamorelin als Arzneimittel zugelassen",
        a: "Nein. Die FDA stoppte 2023 die klinische Entwicklung von Ipamorelin. Es ist weder in der EU noch in den USA zugelassen und wird als Forschungschemikalie gehandelt.",
        q_en: "Is ipamorelin an approved medication",
        a_en: "No. The FDA halted ipamorelin's clinical development in 2023. It is not approved in the EU or the US and is sold as a research chemical."
      },
      {
        q: "Warum wurde die Entwicklung von Ipamorelin gestoppt",
        a: "Nach zwei Todesfällen in einer Studienpopulation schwerkranker Patienten nach Bauchoperationen stellte die FDA die weitere Entwicklung 2023 ein. Ein ursächlicher Zusammenhang mit dem Peptid gilt als wissenschaftlich umstritten.",
        q_en: "Why was ipamorelin's development stopped",
        a_en: "After two deaths occurred in a study population of severely ill patients following abdominal surgery, the FDA halted further development in 2023. A causal link to the peptide is considered scientifically disputed."
      }
    ],
    seo: {
      title: "Ipamorelin im Forschungsüberblick",
      title_en: "Ipamorelin Research Overview",
  ...
  },
  {
    ...
    synonyme: [
      "GRF 1-29",
      "GHRH(1-29)",
      "Geref (historischer Markenname)"
    ],
    kategorie: "Wachstumshormon-Achse",
    studienlage: "klinisch untersucht",
    kurz: "Kurzkettiges Fragment des körpereigenen GHRH, historisch als Arzneimittel zugelassen, heute als Forschungssubstanz gehandelt.",
    kurz_en: "A short-chain fragment of the body's own GHRH, historically approved as a medication, now sold as a research substance.",
    beschreibung: "Sermorelin ist das biologisch aktive Fragment GHRH(1-29) des körpereigenen Growth-Hormone-Releasing-Hormons. Es wurde in den USA 1990 zunächst als Diagnostikum und 1997 für wachstumshormonmangelbedingten Kleinwuchs bei Kindern zugelassen, die Zulassung wurde 2008 aus produktionstechnischen Gründen zurückgezogen. Heute wird es außerhalb dieser historischen Zulassung als Forschungssubstanz untersucht.",
    beschreibung_en: "Sermorelin is the biologically active fragment GHRH(1-29) of the body's own growth hormone-releasing hormone. In the US it was approved in 1990 as a diagnostic agent and in 1997 for growth hormone deficiency-related short stature in children; the approval was withdrawn in 2008 for manufacturing reasons. Today it is studied outside that historical approval as a research substance.",
    mechanismus: "Sermorelin bindet an den GHRH-Rezeptor der somatotropen Zellen in der Hypophyse und aktiviert darüber die Adenylatzyklase-cAMP-Kaskade. Das führt zur Ausschüttung von körpereigenem Wachstumshormon in physiologischen Pulsen. Aufgrund seiner sehr kurzen Halbwertszeit von nur wenigen Minuten fällt der ausgelöste Hormonpuls kurz und moderat aus.",
    mechanismus_en: "Sermorelin binds to the GHRH receptor on somatotroph cells in the pituitary gland and activates the adenylate cyclase-cAMP cascade. This triggers the release of the body's own growth hormone in physiological pulses. Because of its very short half-life of only a few minutes, the resulting hormone pulse is brief and moderate.",
    evidenz: [
      {
        art: "klinisch",
        kurz: "In einer randomisierten, placebokontrollierten Studie an Männern und Frauen im fortgeschrittenen Alter erhöhte ein Nle27-substituiertes GHRH(1-29)-Analogon über mehrere Monate den Wachstumshormon- und IGF-1-Spiegel und verbesserte die fettfreie Körpermasse.",
        kurz_en: "In a randomized, placebo-controlled trial in older men and women, an Nle27-substituted GHRH(1-29) analog raised growth hormone and IGF-1 levels over several months and improved fat-free body mass.",
        quelle: "Khorram et al. 1997, Journal of Clinical Endocrinology & Metabolism, PMID 9141536"
      },
      {
        art: "klinisch",
        kurz: "Eine Übersichtsarbeit zu den vorliegenden klinischen Daten bei Kindern mit Wachstumshormonmangel beschrieb bei einem Großteil der untersuchten Kinder eine beschleunigte Wachstumsgeschwindigkeit über zwölf Monate.",
        kurz_en: "A review of the available clinical data in children with growth hormone deficiency described accelerated growth velocity over twelve months in most of the children studied.",
        quelle: "Prakash & Goa 1999, BioDrugs, PMID 18031173"
      }
    ],
    sicherheit: [
      "In den vorliegenden Studien wurden überwiegend milde, vorübergehende Nebenwirkungen berichtet.",
      "Die ursprüngliche Zulassung wurde 2008 aus produktionstechnischen Gründen zurückgezogen, eine Sicherheitswarnung lag dem nicht zugrunde.",
      "Ein möglicher, uneinheitlich beobachteter Anstieg von LH und FSH wird in der Literatur diskutiert.",
      "Langzeitdaten zur Sicherheit bei gesunden Erwachsenen liegen nicht vor."
    ],
    sicherheit_en: [
      "The available studies mostly reported mild, transient side effects.",
      "The original approval was withdrawn in 2008 for manufacturing reasons; no safety warning was behind this decision.",
      "A possible, inconsistently observed rise in LH and FSH is discussed in the literature.",
      "Long-term safety data in healthy adults are not available."
    ],
    hinweise: [
      "Nur für Forschungszwecke, keine Anwendung am Menschen",
    ...
    faq: [
      {
        q: "War Sermorelin einmal ein zugelassenes Arzneimittel",
        a: "Ja. Sermorelin war in den USA von 1990 bis 2008 zugelassen, zunächst als Diagnostikum, später für wachstumshormonmangelbedingten Kleinwuchs bei Kindern. Die Zulassung wurde aus produktionstechnischen Gründen zurückgezogen, nicht wegen Sicherheitsbedenken.",
        q_en: "Was Sermorelin once an approved medication",
        a_en: "Yes. Sermorelin was approved in the US from 1990 to 2008, first as a diagnostic agent, later for growth hormone deficiency-related short stature in children. The approval was withdrawn for manufacturing reasons, not safety concerns."
      },
      {
        q: "Was ist der Unterschied zwischen Sermorelin und CJC-1295",
        a: "Beide sind GHRH-Analoga. Sermorelin besteht aus den ersten 29 Aminosäuren des körpereigenen GHRH ohne weitere Modifikation, CJC-1295 ist zusätzlich stabilisiert und hat dadurch eine längere Halbwertszeit.",
        q_en: "What is the difference between sermorelin and CJC-1295",
        a_en: "Both are GHRH analogs. Sermorelin consists of the first 29 amino acids of the body's own GHRH with no further modification, while CJC-1295 is additionally stabilized and therefore has a longer half-life."
      },
      {
        q: "Ist Sermorelin heute als Arzneimittel erhältlich",
        a: "Nein. Seit der Marktrücknahme 2008 ist Sermorelin in der EU und den USA nicht mehr als zugelassenes Arzneimittel erhältlich und wird als Forschungschemikalie gehandelt.",
        q_en: "Is sermorelin available as a medication today",
        a_en: "No. Since the market withdrawal in 2008, sermorelin is no longer available as an approved medication in the EU or the US and is sold as a research chemical."
      }
    ],
    seo: {
      title: "Sermorelin im Forschungsüberblick",
      title_en: "Sermorelin Research Overview",
  ...
  },
  {
    ...
    kategorie: "Wachstumshormon-Achse",
    studienlage: "zugelassenes Arzneimittel",
    kurz: "Stabilisiertes GHRH-Analogon, in den USA als Arzneimittel Egrifta zur Reduktion von viszeralem Bauchfett bei HIV-assoziierter Lipodystrophie zugelassen.",
    kurz_en: "A stabilized GHRH analog, approved in the US as the medication Egrifta for reducing visceral abdominal fat in HIV-associated lipodystrophy.",
    beschreibung: "Tesamorelin ist ein stabilisiertes Analogon des vollständigen, 44 Aminosäuren langen GHRH. Unter dem Markennamen Egrifta ist es seit 2010 von der US-amerikanischen FDA für die Reduktion von viszeralem Bauchfett bei HIV-assoziierter Lipodystrophie zugelassen. Damit ist es das einzige Peptid seiner Klasse mit einer abgeschlossenen Phase-3-Zulassungsstudie an über 800 Probanden.",
    beschreibung_en: "Tesamorelin is a stabilized analog of the full 44-amino-acid GHRH. Under the brand name Egrifta, it has been approved by the US FDA since 2010 for reducing visceral abdominal fat in HIV-associated lipodystrophy. This makes it the only peptide in its class with a completed phase 3 approval study in more than 800 participants.",
    mechanismus: "Tesamorelin bindet an den GHRH-Rezeptor der somatotropen Zellen der Hypophyse und regt darüber die körpereigene, pulsatile Ausschüttung von Wachstumshormon an, bei vollständig erhaltener Somatostatin-Rückkopplung. Das freigesetzte Wachstumshormon wird in der Leber zu IGF-1 umgewandelt. Zusätzlich wirkt Tesamorelin relativ selektiv auf Wachstumshormon-Rezeptoren im viszeralen Fettgewebe und aktiviert dort die hormonsensitive Lipase.",
    mechanismus_en: "Tesamorelin binds to the GHRH receptor on somatotroph cells in the pituitary gland, stimulating the body's own pulsatile release of growth hormone while the somatostatin feedback loop remains fully intact. The released growth hormone is converted to IGF-1 in the liver. Tesamorelin also acts relatively selectively on growth hormone receptors in visceral fat tissue, activating hormone-sensitive lipase there.",
    evidenz: [
      {
        art: "klinisch",
        kurz: "In einer randomisierten, placebokontrollierten Phase-3-Studie an Menschen mit HIV-assoziierter Fettumverteilung reduzierte Tesamorelin über 26 Wochen das viszerale Fettgewebe deutlich stärker als Placebo und erhöhte den IGF-1-Spiegel.",
        kurz_en: "In a randomized, placebo-controlled phase 3 trial in people with HIV-associated fat redistribution, tesamorelin reduced visceral fat tissue significantly more than placebo over 26 weeks and raised IGF-1 levels.",
        quelle: "Falutz et al. 2007, New England Journal of Medicine, PMID 18057338"
      },
      {
        art: "klinisch",
        kurz: "Eine weitere randomisierte Studie an HIV-Patienten mit Bauchfettansammlung bestätigte die Reduktion von viszeralem Fettgewebe und zeigte zusätzlich eine Abnahme des Leberfetts.",
        kurz_en: "A further randomized trial in HIV patients with abdominal fat accumulation confirmed the reduction in visceral fat tissue and additionally showed a decrease in liver fat.",
        quelle: "Stanley et al. 2014, JAMA, PMID 25038357"
      }
    ],
    sicherheit: [
      "Häufigste in Studien berichtete Nebenwirkung waren Gelenkschmerzen bei einem Teil der Teilnehmenden.",
      "Wassereinlagerungen in den Extremitäten wurden bei einem kleineren Teil der Teilnehmenden beobachtet, seltener als unter Wachstumshormon.",
      "Der Blutzucker stieg in Studien im Mittel leicht und vorübergehend an.",
      "Laut Fachinformation gilt Tesamorelin bei aktiver Tumorerkrankung, Hypophysentumor, Schwangerschaft oder diabetischer Retinopathie als kontraindiziert."
    ],
    sicherheit_en: [
      "The most common side effect reported in trials was joint pain in a subset of participants.",
      "Fluid retention in the extremities was observed in a smaller portion of participants, less often than with growth hormone.",
      "Blood glucose rose slightly and temporarily on average in trials.",
    ...
    faq: [
      {
        q: "Ist Tesamorelin ein zugelassenes Medikament",
        a: "Ja, unter dem Namen Egrifta seit 2010 in den USA, aber nur für eine spezifische Indikation: die Reduktion von viszeralem Bauchfett bei HIV-assoziierter Lipodystrophie. In der EU besteht keine Zulassung.",
        q_en: "Is tesamorelin an approved medication",
        a_en: "Yes, under the name Egrifta since 2010 in the US, but only for a specific indication: reducing visceral abdominal fat in HIV-associated lipodystrophy. There is no approval in the EU."
      },
      {
        q: "Baut Tesamorelin Muskeln auf",
        a: "Studien zeigen einen Anstieg der fettfreien Körpermasse, davon besteht jedoch ein relevanter Anteil aus Wasser und Bindegewebe. Ein nennenswerter Muskelaufbau ohne zusätzliche Androgenrezeptor-Stimulation ist wissenschaftlich nicht belegt.",
        q_en: "Does tesamorelin build muscle",
        a_en: "Studies show an increase in fat-free body mass, but a relevant share of this consists of water and connective tissue. Notable muscle growth without additional androgen receptor stimulation is not scientifically documented."
      },
      {
        q: "Worin unterscheidet sich Tesamorelin von anderen GHRH-Analoga",
        a: "Tesamorelin ist das einzige GHRH-Analogon mit einer abgeschlossenen Phase-3-Zulassungsstudie an über 800 Probanden und einer aktiven behördlichen Zulassung in den USA. Sermorelin und CJC-1295 erreichten diesen Status bislang nicht.",
        q_en: "How does tesamorelin differ from other GHRH analogs",
        a_en: "Tesamorelin is the only GHRH analog with a completed phase 3 approval study in more than 800 participants and an active regulatory approval in the US. Sermorelin and CJC-1295 have not reached this status."
      }
    ],
    seo: {
      title: "Tesamorelin im Forschungsüberblick",
      title_en: "Tesamorelin Research Overview",
  ...
  },
  {
    ...
    name: "GHK-Cu",
    synonyme: [
      "Glycyl-L-Histidyl-L-Lysin-Kupfer",
      "Kupfertripeptid-1"
    ],
    kategorie: "Haut & Kosmetik",
    studienlage: "frühe klinische Studien",
    kurz: "Ein körpereigenes Kupfer-bindendes Tripeptid, am intensivsten in der Hautforschung untersucht, mit ergänzenden präklinischen Daten zu weiteren Geweben.",
    kurz_en: "A naturally occurring copper-binding tripeptide, studied most extensively in skin research, with additional preclinical data on other tissues.",
    beschreibung: "GHK-Cu ist ein aus drei Aminosäuren bestehendes Tripeptid, das im Körper natürlich vorkommt und stabil ein Kupferion bindet. Es wird vor allem in der kosmetischen und dermatologischen Forschung zu Kollagenbildung und Hauterneuerung untersucht. Weitere, überwiegend präklinische Forschung betrachtet mögliche Effekte auf Entzündungsprozesse und die Genexpression in verschiedenen Gewebemodellen.",
    beschreibung_en: "GHK-Cu is a three-amino-acid tripeptide that occurs naturally in the body and stably binds a copper ion. It is studied mainly in cosmetic and dermatological research on collagen formation and skin renewal. Further, mostly preclinical research looks at possible effects on inflammatory processes and gene expression across various tissue models.",
    mechanismus: "In Hautzellen wird eine Steigerung der Kollagen- und Elastinsynthese sowie eine Aktivierung von Fibroblasten beschrieben, den Zellen, die Bindegewebe aufbauen. In präklinischen Genexpressionsmodellen zeigte GHK-Cu eine kontextabhängige Regulation zahlreicher Gene, die mit Gewebereparatur, oxidativem Stress und Entzündung in Verbindung stehen. Die genaue Übertragbarkeit dieser Genexpressionseffekte auf den lebenden Menschen ist Gegenstand laufender Forschung.",
    mechanismus_en: "In skin cells, GHK-Cu has been described as increasing collagen and elastin synthesis and activating fibroblasts, the cells that build connective tissue. In preclinical gene expression models, GHK-Cu showed context-dependent regulation of numerous genes linked to tissue repair, oxidative stress, and inflammation. The extent to which these gene expression effects transfer to living humans is the subject of ongoing research.",
    evidenz: [
      {
        art: "klinisch",
        kurz: "Eine zwölfwöchige Anwendungsstudie an Frauen mit sichtbaren Zeichen der Hautalterung beschrieb im Vergleich zum Ausgangswert eine erhöhte Hautdicke, reduzierte Faltentiefe und eine per Biopsie bestätigte gesteigerte Aktivität hautbildender Zellen unter einer GHK-Cu-Creme.",
        kurz_en: "A twelve-week application study in women with visible signs of skin aging described increased skin thickness, reduced wrinkle depth, and a biopsy-confirmed increase in skin cell activity under a GHK-Cu cream, compared with baseline.",
        quelle: "Finkley et al. 2005, in: Cosmeceuticals and Active Cosmetics: Drugs vs. Cosmetics"
      },
      {
        art: "präklinisch",
        kurz: "Eine Studie an einem Mausmodell der Colitis ulcerosa beschrieb, dass GHK-Cu über den SIRT1/STAT3-Signalweg die Barrierefunktion der Darmschleimhaut unterstützte und entzündliche Botenstoffe reduzierte.",
        kurz_en: "A study in a mouse model of ulcerative colitis described GHK-Cu supporting intestinal barrier function via the SIRT1/STAT3 pathway and reducing inflammatory messengers.",
        quelle: "Mao et al. 2025, Frontiers in Pharmacology, PMID 40672369"
      }
    ],
    sicherheit: [
      "In den vorliegenden topischen Studien wurden keine relevanten Sicherheitsbedenken beschrieben.",
      "GHK-Cu enthält gebundenes Kupfer, in den üblichen kosmetischen Konzentrationen wird dies nicht mit einer Kupferüberladung in Verbindung gebracht.",
      "Für die injizierbare, systemische Anwendung liegen keine placebokontrollierten Humanstudien zur Sicherheit vor.",
      "Präparate aus nicht kontrollierter Herstellung bergen ein Verunreinigungsrisiko, das unabhängig vom Molekül selbst besteht."
    ],
    sicherheit_en: [
      "The available topical studies described no relevant safety concerns.",
      "GHK-Cu contains bound copper, at typical cosmetic concentrations this is not associated with copper overload.",
      "For injectable, systemic use, no placebo-controlled human safety studies are available.",
      "Products from uncontrolled manufacturing carry a contamination risk that is independent of the molecule itself."
    ],
    hinweise: [
      "Nur für Forschungszwecke, keine Anwendung am Menschen",
    ...
    faq: [
      {
        q: "Ist GHK-Cu in Kosmetik zugelassen?",
        a: "In den USA ist Kupfertripeptid-1 als kosmetischer Inhaltsstoff gelistet. In der EU gibt es keine vergleichbare eigenständige Zulassung, kosmetische Anwendungen werden aber verbreitet angeboten.",
        q_en: "Is GHK-Cu approved in cosmetics?",
        a_en: "In the United States, copper tripeptide-1 is listed as a cosmetic ingredient. The EU has no comparable standalone approval, though cosmetic products are widely sold."
      },
      {
        q: "Worauf bezieht sich die stärkste Evidenz zu GHK-Cu?",
        a: "Die belastbarsten Humandaten stammen aus topischen Hautstudien. Systemische, injizierte Anwendung stützt sich überwiegend auf präklinische Tier- und Zellmodelle.",
        q_en: "Where is the strongest evidence for GHK-Cu?",
        a_en: "The most robust human data come from topical skin studies. Systemic, injected use relies mostly on preclinical animal and cell models."
      },
      {
        q: "Ist Kupfer in GHK-Cu ein Sicherheitsrisiko?",
        a: "In den üblichen kosmetischen Konzentrationen wird dies nicht als relevantes Risiko beschrieben. Ein Kupfermangel gilt in der Literatur als wahrscheinlicher als eine Überladung.",
        q_en: "Is the copper in GHK-Cu a safety risk?",
        a_en: "At typical cosmetic concentrations this is not described as a relevant risk. The literature considers copper deficiency more likely than overload."
      }
    ],
    seo: {
      title: "GHK-Cu: Wirkstoff-Profil & Studienlage",
      title_en: "GHK-Cu: Research Profile & Evidence",
  ...
  },
  {
    ...
    kategorie: "Kognition",
    studienlage: "klinisch untersucht",
    kurz: "Synthetisches Heptapeptid, ein Analogon des körpereigenen Tuftsin, in der Forschung zu Angstregulation und kognitiver Funktion untersucht.",
    kurz_en: "A synthetic heptapeptide analog of the body's own tuftsin, studied in research on anxiety regulation and cognitive function.",
    beschreibung: "Selank ist ein Heptapeptid, das aus dem körpereigenen Tetrapeptid Tuftsin abgeleitet und in Russland ursprünglich als Anxiolytikum entwickelt wurde. In der Forschung steht es im Zusammenhang mit angstregulierenden und leicht kognitionsunterstützenden Effekten, ohne die für Benzodiazepine typische Sedierung.",
    beschreibung_en: "Selank is a heptapeptide derived from the body's own tetrapeptide tuftsin, originally developed in Russia as an anxiolytic. Research links it to anxiety-regulating and mildly cognition-supporting effects, without the sedation typical of benzodiazepines.",
    mechanismus: "Selank wird eine Hemmung der Enkephalinasen zugeschrieben, den Enzymen, die körpereigene Enkephaline abbauen, wodurch deren Spiegel länger erhalten bleiben. Zusätzlich wird eine Modulation des GABA-Rezeptors an einer anderen Bindungsstelle als bei Benzodiazepinen sowie eine indirekte Beeinflussung des Dopaminsystems über den Enkephalin-Signalweg beschrieben.",
    mechanismus_en: "Selank is described as inhibiting enkephalinases, the enzymes that break down the body's own enkephalins, keeping their levels elevated for longer. It is also linked to modulation of the GABA receptor at a binding site distinct from benzodiazepines, and to indirect effects on the dopamine system through the enkephalin pathway.",
    evidenz: [
      {
        art: "klinisch",
        kurz: "In einer randomisierten Studie an 62 Personen mit generalisierter Angststörung oder Neurasthenie wurde die anxiolytische Wirkung von Selank mit Medazepam verglichen, mit zusätzlich beobachteter Verbesserung von Energie und Konzentration ohne Sedierung.",
        kurz_en: "A randomized trial in 62 people with generalized anxiety disorder or neurasthenia compared the anxiolytic effect of selank to medazepam, with additionally observed improvements in energy and concentration without sedation.",
        quelle: "Zozulya AA et al. 2008, Bjulleten Eksperimentalnoj Biologii i Mediciny, PMID 18454096"
      },
      {
        art: "klinisch",
        kurz: "In einer fMRT-Studie an 52 gesunden Probanden wurde nach Gabe von Selank eine veränderte funktionelle Konnektivität zwischen rechter Amygdala und rechtem Temporalkortex gemessen, bereits 5 Minuten nach Anwendung.",
        kurz_en: "In an fMRI study with 52 healthy participants, selank administration was associated with altered functional connectivity between the right amygdala and right temporal cortex, measurable as early as 5 minutes after application.",
        quelle: "Panikratova KR et al. 2020, Doklady Biological Sciences, Bd. 490, S. 9-11"
      }
    ],
    sicherheit: [
      "In der verfügbaren Studienliteratur wurden milde, vorübergehende Effekte wie nasale Reizung bei intranasaler Anwendung beschrieben.",
      "Eine gleichzeitige Anwendung mit Benzodiazepinen wird in der Literatur wegen möglicher gegenseitiger Rezeptor-Wechselwirkung diskutiert.",
      "Belastbare Langzeit-Sicherheitsdaten aus unabhängigen, außerhalb Russlands durchgeführten Studien liegen bisher nicht vor."
    ],
    sicherheit_en: [
      "Available study literature describes mild, transient effects such as nasal irritation with intranasal use.",
      "Concurrent use with benzodiazepines is discussed in the literature due to possible mutual receptor interaction.",
    ...
    faq: [
      {
        q: "Ist Selank das Gleiche wie ein Benzodiazepin?",
        a: "Nein. Beide wirken auf unterschiedliche Weise auf das GABA-System, Selank bindet an einer anderen Stelle und zeigte in Studien kein Sedierungs- oder Abhängigkeitspotenzial wie klassische Benzodiazepine.",
        q_en: "Is selank the same as a benzodiazepine?",
        a_en: "No. Both act on the GABA system in different ways. Selank binds at a different site and showed no sedative or dependence potential in studies, unlike classic benzodiazepines."
      },
      {
        q: "Woher stammt Selank?",
        a: "Selank wurde an der Russischen Akademie der Wissenschaften aus dem körpereigenen Peptid Tuftsin entwickelt, mit einem stabilisierenden Anhang für eine längere Wirkdauer im Körper.",
        q_en: "Where does selank come from?",
        a_en: "Selank was developed at the Russian Academy of Sciences from the body's own peptide tuftsin, with a stabilizing addition for a longer duration in the body."
      },
      {
        q: "Ist Selank in Deutschland legal erhältlich?",
        a: "Selank ist in Deutschland und der EU nicht als Arzneimittel zugelassen. Es wird ausschließlich als Forschungschemikalie für Laborzwecke angeboten, nicht für die Anwendung am Menschen.",
        q_en: "Is selank legally available in Germany?",
        a_en: "Selank is not approved as a medication in Germany or the EU. It is offered exclusively as a research chemical for laboratory purposes, not for human use."
      }
    ],
    seo: {
      title: "Selank: Forschungspeptid zur Angstregulation",
      title_en: "Selank: Research Peptide for Anxiety Regulation",
  ...
  },
  {
    ...
    kategorie: "Kognition",
    studienlage: "klinisch untersucht",
    kurz: "Synthetisches Heptapeptid auf ACTH-Basis, in Russland zur Neuroprotektion zugelassen und in der Forschung zu Kognition und Stressadaptation untersucht.",
    kurz_en: "A synthetic ACTH-derived heptapeptide, approved in Russia for neuroprotection and studied in research on cognition and stress adaptation.",
    beschreibung: "Semax ist ein Heptapeptid, das vom Fragment ACTH(4-10) des Stresshormons ACTH abgeleitet wurde und in Russland als Arzneimittel bei ischämischem Schlaganfall zugelassen ist. In der Forschung wird es zusätzlich im Zusammenhang mit Neuroplastizität und kognitiver Funktion betrachtet, ohne die Cortisol-Achse zu aktivieren.",
    beschreibung_en: "Semax is a heptapeptide derived from the ACTH(4-10) fragment of the stress hormone ACTH, approved as a medication for ischemic stroke in Russia. Research also examines it in relation to neuroplasticity and cognitive function, without activating the cortisol axis.",
    mechanismus: "Semax wird eine Hochregulation von BDNF und dessen Rezeptor TrkB zugeschrieben, was mit neuronaler Plastizität in Verbindung gebracht wird. Als ACTH-Abkömmling bindet es zudem an Melanocortin-Rezeptoren, was den Dopamin-, Serotonin- und Noradrenalin-Haushalt beeinflussen kann. Eine 2025 beschriebene Bindung an den µ-Opioid-Rezeptor wird mit antioxidativen Effekten in Verbindung gebracht.",
    mechanismus_en: "Semax is described as upregulating BDNF and its receptor TrkB, which is linked to neuronal plasticity. As an ACTH derivative, it also binds melanocortin receptors, which can influence dopamine, serotonin, and noradrenaline levels. Binding to the mu-opioid receptor, described in 2025, has been linked to antioxidant effects.",
    evidenz: [
      {
        art: "präklinisch",
        kurz: "In einer Studie an Ratten erhöhte eine einzelne intranasale Gabe von Semax die BDNF-Proteinmenge im Hippocampus um das 1,4-Fache und die TrkB-Phosphorylierung um das 1,6-Fache.",
        kurz_en: "In a rat study, a single intranasal application of semax increased hippocampal BDNF protein levels 1.4-fold and TrkB phosphorylation 1.6-fold.",
        quelle: "PubMed ID 14556513"
      },
      {
        art: "klinisch",
        kurz: "In einer fMRT-Studie an 52 gesunden Probanden zeigte auch Semax eine veränderte funktionelle Konnektivität zwischen Amygdala und Temporalkortex, mit teils von Selank unterscheidbaren Effekten.",
        kurz_en: "In the same fMRI study with 52 healthy participants, semax also showed altered functional connectivity between the amygdala and temporal cortex, with effects that were in part distinguishable from selank.",
        quelle: "Panikratova KR et al. 2020, Doklady Biological Sciences, Bd. 490, S. 9-11"
      }
    ],
    sicherheit: [
      "In Tierstudien wurden bislang keine schwerwiegenden toxischen Effekte berichtet.",
      "Eine In-vitro-Wechselwirkung mit kupferabhängigen Enzymen wurde beschrieben, deren klinische Relevanz noch nicht geklärt ist.",
      "Unabhängige westliche Langzeit-Sicherheitsdaten am Menschen liegen bisher nicht vor."
    ],
    sicherheit_en: [
      "Animal studies have so far reported no serious toxic effects.",
      "An in vitro interaction with copper-dependent enzymes has been described, its clinical relevance not yet established.",
    ...
    faq: [
      {
        q: "Wirkt Semax wie ein klassisches Nootropikum?",
        a: "Semax wird in der Forschung vor allem mit neuroprotektiven und BDNF-bezogenen Effekten in Verbindung gebracht, weniger mit einem akuten Fokus-Effekt wie klassische Stimulanzien.",
        q_en: "Does semax act like a classic nootropic?",
        a_en: "Research links semax primarily to neuroprotective and BDNF-related effects, less to an acute focus effect like classic stimulants."
      },
      {
        q: "Ist Semax das Gleiche wie Selank?",
        a: "Nein, beide sind verwandte russische Peptide mit unterschiedlichem Ursprung. Semax leitet sich von ACTH ab und wird vor allem mit Neuroprotektion verbunden, Selank von Tuftsin und vor allem mit Angstregulation.",
        q_en: "Is semax the same as selank?",
        a_en: "No, both are related Russian peptides with different origins. Semax derives from ACTH and is mainly linked to neuroprotection, selank from tuftsin and mainly to anxiety regulation."
      },
      {
        q: "Ist Semax in Deutschland legal erhältlich?",
        a: "Semax ist in Deutschland und der EU nicht als Arzneimittel zugelassen und wird ausschließlich als Forschungschemikalie für Laborzwecke angeboten, nicht für die Anwendung am Menschen.",
        q_en: "Is semax legally available in Germany?",
        a_en: "Semax is not approved as a medication in Germany or the EU and is offered exclusively as a research chemical for laboratory purposes, not for human use."
      }
    ],
    seo: {
      title: "Semax: ACTH-Forschungspeptid zur Neuroprotektion",
      title_en: "Semax: ACTH Research Peptide for Neuroprotection",
  ...
  },
  {
    ...
    kategorie: "Immunsystem",
    studienlage: "zugelassenes Arzneimittel",
    kurz: "Ein körpereigenes Immun-Peptid aus der Thymusdrüse, in mehr als 35 Ländern als Arzneimittel zugelassen, in Deutschland, Österreich und der Schweiz derzeit nicht.",
    kurz_en: "A naturally occurring thymus-derived immune peptide, approved as a medication in more than 35 countries, though not currently in Germany, Austria, or Switzerland.",
    beschreibung: "Thymosin Alpha 1 ist ein aus 28 Aminosäuren bestehendes Peptid, das ursprünglich aus der Thymusdrüse isoliert wurde, dem zentralen Organ der Reifung von T-Zellen. Es wirkt als Immunmodulator und wird sowohl in der klinischen Forschung als auch, unter dem Handelsnamen Zadaxin, als zugelassenes Präparat bei bestimmten Immunerkrankungen eingesetzt. Untersucht werden unter anderem chronische Virusinfektionen, die Immunantwort auf Impfungen und eine unterstützende Rolle in der Onkologie.",
    beschreibung_en: "Thymosin alpha 1 is a 28-amino-acid peptide originally isolated from the thymus gland, the central organ where T cells mature. It acts as an immune modulator and is used both in clinical research and, under the trade name Zadaxin, as an approved medication for certain immune conditions. Areas of study include chronic viral infections, the immune response to vaccination, and a supportive role in oncology.",
    mechanismus: "Die Wirkung wird primär über Toll-like-Rezeptoren auf Immunzellen beschrieben, molekulare Erkennungsstrukturen, die auf Krankheitserreger reagieren. Darüber werden Signalwege wie NF-κB und die Interferon-Produktion aktiviert, was sowohl das angeborene als auch das erworbene Immunsystem gleichzeitig anspricht. Beschrieben werden unter anderem eine gesteigerte Aktivität von T-Zellen und natürlichen Killerzellen sowie eine verbesserte Antikörperproduktion.",
    mechanismus_en: "The effect is primarily described via Toll-like receptors on immune cells, molecular recognition structures that respond to pathogens. This activates pathways such as NF-κB and interferon production, engaging both the innate and the adaptive immune system at once. Described effects include increased activity of T cells and natural killer cells, as well as improved antibody production.",
    evidenz: [
      {
        art: "klinisch",
        kurz: "Eine retrospektive Auswertung von 76 schwer an COVID-19 erkrankten Patienten aus zwei Kliniken beschrieb eine geringere Sterblichkeit unter Thymosin Alpha 1 im Vergleich zur unbehandelten Gruppe, begleitet von einer Erholung der T-Zell-Zahlen.",
        kurz_en: "A retrospective review of 76 patients with severe COVID-19 across two hospitals described lower mortality under thymosin alpha 1 compared with the untreated group, accompanied by a recovery of T-cell counts.",
        quelle: "Liu et al. 2020, Clinical Infectious Diseases"
      },
      {
        art: "klinisch",
        kurz: "Eine randomisierte Studie an 42 Patienten mit nicht-kleinzelligem Lungenkarzinom nach Bestrahlung beschrieb unter Thymosin Alpha 1 eine schnellere Normalisierung der T-Zell-Funktion gegenüber Placebo sowie einen Überlebensvorteil, am stärksten bei Patienten mit kleineren Tumoren.",
        kurz_en: "A randomized trial in 42 patients with non-small cell lung cancer after radiation described faster normalization of T-cell function under thymosin alpha 1 versus placebo, along with a survival benefit, most pronounced in patients with smaller tumors.",
        quelle: "Schulof et al. 1985, Journal of Biological Response Modifiers, PMID 3998766"
      }
    ],
    sicherheit: [
      "In großen Sicherheitsdatenbanken mit tausenden behandelten Patienten wurden überwiegend milde, vorübergehende Reaktionen an der Injektionsstelle sowie leichte Müdigkeit beschrieben.",
      "Selten wurden allergische Hautreaktionen und ein vorübergehendes Aufflammen bereits bestehender Autoimmunerkrankungen berichtet.",
      "Die gleichzeitige Einnahme immunsuppressiver Medikamente gilt in der Fachinformation als Gegenanzeige, da sich die Wirkungen entgegengesetzt richten.",
      "Für aktive Organtransplantationen und aktive Autoimmunerkrankungen wird in der Fachinformation zur Vorsicht geraten."
    ],
    sicherheit_en: [
      "Large safety databases covering thousands of patients describe mostly mild, transient injection-site reactions and slight fatigue.",
      "Rare reports include allergic skin reactions and a temporary flare of pre-existing autoimmune conditions.",
      "Concurrent use of immunosuppressive medication is listed as a contraindication in the product information, since the effects work in opposite directions.",
    ...
    faq: [
      {
        q: "Ist Thymosin Alpha 1 ein zugelassenes Medikament?",
        a: "Ja, unter dem Handelsnamen Zadaxin in mehr als 35 Ländern, unter anderem bei chronischer Hepatitis B und C. In Deutschland, Österreich und der Schweiz gibt es derzeit keine Zulassung.",
        q_en: "Is thymosin alpha 1 an approved medication?",
        a_en: "Yes, under the trade name Zadaxin in more than 35 countries, including for chronic hepatitis B and C. There is currently no approval in Germany, Austria, or Switzerland."
      },
      {
        q: "Worauf wirkt Thymosin Alpha 1 im Immunsystem?",
        a: "Es wirkt gleichzeitig auf das angeborene und das erworbene Immunsystem, unter anderem über eine gesteigerte Aktivität von T-Zellen, natürlichen Killerzellen und eine verbesserte Antikörperbildung.",
        q_en: "What does thymosin alpha 1 act on in the immune system?",
        a_en: "It acts on both the innate and the adaptive immune system at once, including through increased activity of T cells and natural killer cells, and improved antibody formation."
      },
      {
        q: "Gibt es Humanstudien zu Thymosin Alpha 1?",
        a: "Ja, im Vergleich zu vielen anderen Peptiden existiert eine breitere Basis an klinischen Studien, unter anderem zu schweren Virusinfektionen, einer unterstützenden Rolle bei Krebserkrankungen und dem Ansprechen auf Impfungen.",
        q_en: "Are there human studies on thymosin alpha 1?",
        a_en: "Yes, compared with many other peptides there is a broader base of clinical studies, including work on severe viral infections, a supportive role in cancer care, and vaccine response."
      }
    ],
    seo: {
      title: "Thymosin Alpha 1: Wirkstoff-Profil & Studienlage",
      title_en: "Thymosin Alpha 1: Research Profile & Evidence",
  ...
  },
  {
    ...
    kategorie: "Sonstige",
    studienlage: "präklinisch",
    kurz: "Synthetisches Tetrapeptid, in der Alternsforschung als Forschungssubstanz zur Zellalterung untersucht.",
    kurz_en: "A synthetic tetrapeptide, studied in aging research as a research substance related to cellular aging.",
    beschreibung: "Epitalon ist ein synthetisches Tetrapeptid, das von Vladimir Khavinson am Sankt Petersburger Institut für Bioregulation und Gerontologie entwickelt wurde. Es wird in präklinischen Studien im Zusammenhang mit Zellalterung und der Regulation der Telomerase-Aktivität untersucht. Belastbare klinische Daten am Menschen stehen bislang aus.",
    beschreibung_en: "Epitalon is a synthetic tetrapeptide developed by Vladimir Khavinson at the Saint Petersburg Institute of Bioregulation and Gerontology. It is studied in preclinical research in connection with cellular aging and the regulation of telomerase activity. Robust clinical data in humans is still pending.",
    mechanismus: "Epitalon wird eine Erhöhung der Telomerase-Aktivität in Zellkulturen zugeschrieben, die in vitro mit einer Verlängerung von Telomeren einherging. Zusätzlich werden Effekte auf die Melatonin-Synthese sowie auf Botenstoffe des Immunsystems beschrieben.",
    mechanismus_en: "Epitalon has been described as increasing telomerase activity in cell cultures, which was associated with telomere elongation in vitro. Effects on melatonin synthesis and on immune system signaling molecules have also been described.",
    evidenz: [
      {
        art: "präklinisch",
        kurz: "In humanen fetalen Fibroblasten-Zellkulturen induzierte Epitalon die Expression der katalytischen Telomerase-Untereinheit sowie eine messbare Telomerase-Aktivität, verbunden mit einer Verlängerung der Telomere.",
        kurz_en: "In human fetal fibroblast cell cultures, epitalon induced expression of the catalytic telomerase subunit and measurable telomerase activity, associated with telomere elongation.",
        quelle: "Khavinson VKh, Bondarev IE, Butyugov AA 2003, Bulletin of Experimental Biology and Medicine 135:590-592"
      },
      {
        art: "präklinisch",
        kurz: "In Tiermodellen wurden Effekte von Epitalon auf die Melatonin-Ausschüttung sowie auf Parameter des Immunsystems beschrieben, mit uneinheitlichen Ergebnissen zur Lebensspanne je nach Modell und Protokoll.",
        kurz_en: "In animal models, effects of epitalon on melatonin release and on immune system parameters have been described, with mixed results on lifespan depending on the model and protocol used.",
        quelle: "Khavinson VKh, Morozov VG 2003, Neuroendocrinology Letters"
      }
    ],
    sicherheit: [
      "Aus präklinischen Untersuchungen sind bislang keine schwerwiegenden toxischen Effekte beschrieben.",
      "Kontrollierte Sicherheitsstudien am Menschen nach westlichem Studienstandard liegen nicht vor.",
      "Zur langfristigen Anwendung existieren keine belastbaren Daten."
    ],
    sicherheit_en: [
      "Preclinical research has so far described no serious toxic effects.",
      "Controlled human safety studies meeting Western trial standards are not available.",
      "No robust data exist on long-term use."
    ],
    hinweise: [
    ...
    faq: [
      {
        q: "Ist Epitalon am Menschen erforscht?",
        a: "Die vorliegenden Daten stammen überwiegend aus Zellkultur- und Tiermodellen. Kontrollierte klinische Studien am Menschen nach westlichem Standard liegen bislang nicht vor.",
        q_en: "Has epitalon been studied in humans?",
        a_en: "Available data come predominantly from cell culture and animal models. Controlled clinical studies in humans meeting Western standards are not yet available."
      },
      {
        q: "Was hat Epitalon mit Telomeren zu tun?",
        a: "In Zellkulturstudien wurde eine Erhöhung der Telomerase-Aktivität und eine Verlängerung von Telomeren beobachtet. Ob sich das auf den gesamten Organismus überträgt, ist offen.",
        q_en: "What does epitalon have to do with telomeres?",
        a_en: "Cell culture studies observed an increase in telomerase activity and telomere elongation. Whether this translates to the whole organism remains open."
      },
      {
        q: "Ist Epitalon in Deutschland legal erhältlich?",
        a: "Epitalon ist nicht als Arzneimittel zugelassen und wird ausschließlich als Forschungschemikalie angeboten, nicht für die Anwendung am Menschen.",
        q_en: "Is epitalon legally available in Germany?",
        a_en: "Epitalon is not approved as a medication and is offered exclusively as a research chemical, not for human use."
      }
    ],
    seo: {
      title: "Epitalon: Tetrapeptid in der Alternsforschung",
      title_en: "Epitalon: Tetrapeptide in Aging Research",
  ...
  },
  {
    ...
    kategorie: "Sonstige",
    studienlage: "frühe klinische Studien",
    kurz: "Ein synthetisches Analogon des körpereigenen Hormons Alpha-MSH, in frühen klinischen Studien zu Pigmentierung und sexueller Funktion untersucht.",
    kurz_en: "A synthetic analog of the body's own hormone alpha-MSH, studied in early clinical trials on pigmentation and sexual function.",
    beschreibung: "Melanotan II ist ein synthetisches, ringförmiges Peptid aus sieben Aminosäuren, das an mehrere Melanocortin-Rezeptoren im Körper bindet. Es wurde in den 1980er-Jahren an der University of Arizona entwickelt und ist deutlich potenter als das natürliche Vorbild Alpha-MSH. Untersucht wird unter anderem eine Rolle bei der Pigmentierung der Haut sowie bei sexuellem Verlangen und Erregung.",
    beschreibung_en: "Melanotan II is a synthetic, cyclic seven-amino-acid peptide that binds several melanocortin receptors in the body. It was developed in the 1980s at the University of Arizona and is considerably more potent than its natural counterpart, alpha-MSH. Areas of study include a role in skin pigmentation as well as sexual desire and arousal.",
    mechanismus: "Über den Rezeptor MC1R auf Hautpigmentzellen wird eine Bildung von Eumelanin ausgelöst, die unabhängig von UV-Strahlung abläuft. Über den Rezeptor MC4R im zentralen Nervensystem wird ein Effekt auf sexuelles Verlangen und Erregung beschrieben, sowie eine appetitregulierende Wirkung. Weil Melanotan II nicht selektiv mehrere Rezeptoren gleichzeitig aktiviert, ist das Zusammenspiel dieser Effekte komplexer als bei den selektiveren, verwandten Wirkstoffen.",
    mechanismus_en: "Via the MC1R receptor on skin pigment cells, melanotan II triggers eumelanin production that occurs independently of UV exposure. Via the MC4R receptor in the central nervous system, an effect on sexual desire and arousal is described, along with an appetite-regulating effect. Because melanotan II activates several receptors non-selectively at once, the interplay of these effects is more complex than with the more selective, related compounds.",
    evidenz: [
      {
        art: "klinisch",
        kurz: "Eine Phase-1-Pilotstudie an drei männlichen Probanden beschrieb nach wiederholten subkutanen Injektionen eine deutliche Hautpigmentierung ohne UV-Exposition, begleitet von Übelkeit, Hautrötung und spontanen Erektionen als häufigste unerwünschte Wirkungen.",
        kurz_en: "A phase 1 pilot study in three male volunteers described marked skin pigmentation without UV exposure after repeated subcutaneous injections, accompanied by nausea, flushing, and spontaneous erections as the most common adverse effects.",
        quelle: "Dorr et al. 1996, Life Sciences, PMID 8637402"
      },
      {
        art: "klinisch",
        kurz: "Eine doppelblinde, placebokontrollierte Crossover-Studie an Männern mit psychogener erektiler Dysfunktion beschrieb bei 8 von 10 Teilnehmern eine Erektion nach Melanotan-II-Injektion, mit signifikant längerer Rigidität als unter Placebo.",
        kurz_en: "A double-blind, placebo-controlled crossover study in men with psychogenic erectile dysfunction described an erection in 8 of 10 participants following melanotan II injection, with significantly longer rigidity than under placebo.",
        quelle: "Hadley et al. 1998, PMID 9679884"
      }
    ],
    sicherheit: [
      "Häufig berichtete akute Effekte sind Übelkeit und Gesichtsrötung, die auf eine Histaminfreisetzung zurückgeführt werden.",
      "Leichte Erhöhungen von Blutdruck und Puls wurden beobachtet.",
      "Ein medizinischer Notfall in Form einer über Stunden anhaltenden Erektion wurde als seltene, aber ernstzunehmende Nebenwirkung dokumentiert.",
      "In Fallberichten wurde eine Neubildung oder Verdunkelung von Muttermalen beschrieben, meist im Zusammenhang mit gleichzeitiger UV-Exposition. Ein ursächlicher Zusammenhang mit Hautkrebs ist nicht belegt."
    ],
    sicherheit_en: [
      "Commonly reported acute effects are nausea and facial flushing, attributed to histamine release.",
      "Mild increases in blood pressure and pulse have been observed.",
      "A medical emergency involving an erection lasting several hours has been documented as a rare but serious side effect.",
    ...
    faq: [
      {
        q: "Ist Melanotan II zugelassen?",
        a: "Nein, Melanotan II selbst ist weder in der EU noch in den USA zugelassen. Es wird ausschließlich als Forschungschemikalie gehandelt, drei verwandte Wirkstoffe sind dagegen für andere Indikationen zugelassen.",
        q_en: "Is melanotan II approved?",
        a_en: "No, melanotan II itself is not approved in the EU or the United States. It is sold only as a research chemical, while three related compounds are approved for other indications."
      },
      {
        q: "Wirkt Melanotan II nur mit Sonnenlicht?",
        a: "Nein. Die Pigmentbildung läuft laut Studien unabhängig von UV-Strahlung ab. UV-Licht kann den Effekt zusätzlich verstärken, ist dafür aber nicht notwendig.",
        q_en: "Does melanotan II only work with sunlight?",
        a_en: "No. According to studies, pigment formation occurs independently of UV exposure. UV light can further enhance the effect but is not required for it."
      },
      {
        q: "Welche Nebenwirkungen wurden in Studien beschrieben?",
        a: "Am häufigsten Übelkeit und Gesichtsrötung. Seltener wurden Blutdruckanstiege, eine anhaltende Erektion als medizinischer Notfall sowie eine Veränderung von Muttermalen beschrieben.",
        q_en: "What side effects have studies described?",
        a_en: "Most commonly nausea and facial flushing. Less often, increases in blood pressure, a prolonged erection as a medical emergency, and changes in moles have been described."
      }
    ],
    seo: {
      title: "Melanotan II: Wirkstoff-Profil & Studienlage",
      title_en: "Melanotan II: Research Profile & Evidence",
